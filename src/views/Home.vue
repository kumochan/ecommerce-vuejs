                ...
                <div class="main-friend-list">
                  ...
                  >
                    <a class="media-left" href="#!">
                      <img
                        ...
                        src="../assets/admindek/images/avatar-3.jpg"
                  ...
                  >
                    <a class="media-left" href="#!">
                      <img
                        ...
                        src="../assets/admindek/images/avatar-2.jpg"
                        alt="Generic placeholder image"
                      />
                      <div class="live-status bg-success"></div>
                    </a>
                  ...
                  >
                    <a class="media-left" href="#!">
                      <img
                        class="media-object img-radius"
                        src="../assets/admindek/images/avatar-4.jpg"
                        alt="Generic placeholder image"
                      />
                      <div class="live-status bg-success"></div>
                    </a>
                  ...
                  >
                    ...
                    <div class="media-body">
                      <div class="f-13 chat-header">
                        Suzen<small class="d-block text-muted"
                          >15 min ago</small
                        >
                      </div>
                    </div>
